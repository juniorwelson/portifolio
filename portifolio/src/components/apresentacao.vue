...
<div id="texto">
    ...
    <div id="linha">
<h1>-Desenvolvedor <span>Front-End</span></h1><div id="barra"></div>
</div>
<div id="icones">
...
<div id="acao">
    <a class="social"  target="_blank" href="https://github.com/juniorwelson/curriculo-welson/blob/main/cv-welson%201%20(1).pdf">Download CV</a>
...
<img src="../public/img/ft de frente com pc.png" alt="" id="logo">
...
#logo{
    border-radius: 30px;
    box-shadow: 10px 10px 15px aqua;
    width: 500px;
    margin-bottom: 10%;
}
